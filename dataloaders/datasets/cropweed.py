...
class CropWeedSegmentation(data.Dataset):
    NUM_CLASSES = 3

    def __init__(self, args, root='/home/robot/datasets/structured_cwc/', split="train"):
        ...
        self.class_names = ['background', 'plants', 'weeds']
